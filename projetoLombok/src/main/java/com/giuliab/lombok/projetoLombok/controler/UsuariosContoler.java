package com.giuliab.lombok.projetoLombok.controler;
...
import com.giuliab.lombok.projetoLombok.services.Usuarioservice;

import jakarta.validation.Valid;

@RestController
@RequestMapping("/usuario")
public class UsuariosContoler {
	private final Usuarioservice usuarioService;

	@Autowired
	public UsuariosContoler(Usuarioservice usuarioService) {
